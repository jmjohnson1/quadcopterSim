...
const.Kp_att = diag([1.6, 1.7, 0.12]);
const.Ki_att = diag([2.4, 2.3, 0.02]);
const.Kd_att = diag([0.28, 0.28, 0.1]);

% Position
const.Kp_pos = diag([9.88,  9.88,  11.34]);
const.Ki_pos = diag([0.3,  0.3,  2.93]);
const.Kd_pos = diag([11.85,  11.85, 16.29]);
